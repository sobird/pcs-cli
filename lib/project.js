...
exports.getPath = function(root, args){
...
exports.getRoot = function() {
    if(PRO_ROOT) {
        return exports.getPath(PRO_ROOT, arguments);
    } else {
...
exports.getTemp = function() {
    ...
    return exports.getPath(TMP_ROOT, arguments);
};
...
exports.getCache = function(){
    return exports.getPath(exports.getTemp('cache'), arguments);
};
